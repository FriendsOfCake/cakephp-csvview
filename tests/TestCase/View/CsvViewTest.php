...
class CsvViewTest extends TestCase
{
    ...
    public function testBom()
    {
        ...
        $data = [['test']];
        $this->view->set(['data' => $data, '_bom' => true, '_csvEncoding' => 'UTF-16LE']);
        $this->view->setConfig('serialize', 'data');
    ...
    public function testBomMultipleContentRows()
    {
        ...
        $this->view->set(['data' => $data, '_bom' => true, '_csvEncoding' => 'UTF-8']);
        $this->view->setConfig('serialize', 'data');
    ...
    public function testBomMultipleContentRowsWithHeader()
    {
        ...
        $this->view->set(['data' => $data, '_header' => $header, '_bom' => true, '_csvEncoding' => 'UTF-8']);
        $this->view->setConfig('serialize', 'data');
    ...
    public function testRenderWithCustomEncoding()
    {
        ...
        $this->view
            ->set('data', $data)
            ->setConfig('serialize', 'data')
            ->set('_dataEncoding', 'UTF-8')
            ->set('_csvEncoding', 'SJIS');
        $output = $this->view->render();
    ...
    public function testRenderViaExtract()
    {
        ...
        $this->view->setConfig('serialize', 'user');
...
CSV;
    ...
    public function testPassingQueryAsData()
    {
        ...
        $this->view->set(['data' => $query, '_extract' => $_extract]);
        $this->view->setConfig('serialize', 'data');
        $output = $this->view->render();
